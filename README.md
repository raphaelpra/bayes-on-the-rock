...
Chill out it is only probabilities...

Little tool to easily calculate discrete probabilities

### Usage

You need to have [nodejs](https://nodejs.org/en/) properly installed on your computer

```bash
git clone https://github.com/raphaelpra/bayes-on-the-rock.git
cd bayes-on-the-rock

# Install dependencies
npm install

# Have a look at modify at the file start-here.js 
npm run exemples
```

You can edit the file `start-here.js` and launch again to improve your understanding of bayes theory
